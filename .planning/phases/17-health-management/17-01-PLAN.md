...
must_haves:
  truths:
    ...
    - "Tooltip shows accurate current/pending/future values"
  artifacts:
...
5. Update OnParametersSet to call color calculation and set BarColorClass
...
Build project: `dotnet build Threa/Threa.Client/Threa.Client.csproj`
Run app and verify:
1. Low health character shows red bar (FAT or VIT < 25%)
2. Medium health character shows yellow bar (25-50%)
3. Full/high health character shows green bar (>50%)
4. When pending healing would exceed max, overheal badge appears
  </verify>
  <done>
